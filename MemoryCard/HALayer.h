 ...
 *	@param	c2			input 2
 **/
extern bool charEquals(const char c1, const char c2);

/**
 *	Hardware Abstraction Layer initialization
 **/
extern void HALayerInit(void);
 ...
 **/
extern void sendCommand(unsigned char command, unsigned char argA, unsigned char argB,
 ...
 **/
extern bool setBLockLength(void);
 ...
 **/
extern unsigned long getPartitionOffset(void);
 ...
 **/
extern unsigned int readSector(unsigned long sector, unsigned char *buf);
 ...
 *	@return	...			number of bytes read
 **/
extern unsigned int readPartialSector(unsigned long sector, unsigned int byteOffset, unsigned int bytesToRead, unsigned char *buf);
 ...
 *	@return	...			number of bytes read
 **/
extern unsigned int readPartialMultiSector(unsigned long sector1,
 ...
 **/
extern unsigned int writeSector(unsigned long sector, unsigned char *buf);
 ...
 *	@return	...			number of bytes written
 **/
extern unsigned int writePartialSector(unsigned long sector,
                                unsigned int byteOffset,
 ...
 *	@return	...				number of bytes written
 **/
extern unsigned int writePartialMultiSector(unsigned long sector1,
                                     unsigned long sector2,
                                     unsigned int byteOffset,
                                     unsigned int bytesToWrite,
                                     unsigned char *buf);
